...
class TestReviewActionClose:
    @patch("titantrade.protection._cleanup_trailing_state")
    @patch("titantrade.protection.close_position_at_market")
    @patch("titantrade.protection.cancel_all_orders_for_ticker", return_value=0)
    ...
    @patch("titantrade.protection.close_position_at_market")
    @patch("titantrade.protection.cancel_all_orders_for_ticker")
    @patch("titantrade.protection.get_positions")
